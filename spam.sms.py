...
#logo
os.system('clear')
print ('\033[36mSubscribe yt ku ngab \033[37mRendiGanz \033[36mok! :v')
os.system('termux-open-url https://youtube.com/channel/UCM2tbmt-r39Dvn7rlZRsSyw')
sleep(4)
os.system('clear')
print ('\033[36mJoin Grub \033[37mDark Cyber')
os.system('termux-open-url https://t.me/+_NnVj-WOjDE0ZjI1')
sleep(3)
os.system('clear')
banner= """
...
\033[33m      |_|
\033[32m[•]───────────────────────────────────────────[•]
\033[32m | \033[94m[+]  \033[32mAuthor  : \033[35mRendiGANZ                    \033[32m |
